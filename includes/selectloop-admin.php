<?php
    ...
    if ($rowcount > 0) {
            ...
            <div>
                ...
                <div class="audio-c">
                    ...
                    <div class="l-midi-c">
                        ...
                        <a href="includes\delete-simple.php?id='.$row["idsimple"].'" class="d-btn" id="midi-btn-delete">Delete</a>
                    </div>                            
                </div>
            </div>
        </div>';
        ...
        for($page = 1; $page<= $number_of_page; $page++) {  
            echo '<a class="Page-links" href = "Dashboard.php?Action=Simples&Spage=' . $page . '">' . $page . ' </a>';
        } 
        echo '</div>';
    } else {
        if($page>1){
            echo '<script>
            window.location.href = "Dashboard.php?Action=Simples&Spage=1";
            </script>';
        }else{
